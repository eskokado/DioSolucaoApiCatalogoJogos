using ApiCatalogoJogos.Businnes.Services;
...
namespace ApiCatalogoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<IEnumerable<JogoViewModel>>> Obter([FromQuery, Range(1, int.MaxValue)] int pagina = 1, [FromQuery, Range(1, 50)] int quantidade = 24)
        {
